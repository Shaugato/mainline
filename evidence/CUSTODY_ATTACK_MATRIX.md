...
| generated_at | 2026-08-09T18:45:23Z |
...
|---|---|---|---|---|---|
| **A1** `delete_and_relink` | T1 | check 3 *(primary)* · check 2 · check 16 | 181 ms | check 3, check 2, check 16 | yes |
| **A2** `renumber_only` | T1 | check 9 *(primary)* · check 2 · check 3 · check 16 | 246 ms | check 9, check 3, check 16 | yes (+extra) |
| **A3** `payload_substitute` | T1 | check 1 *(primary)* | 209 ms | check 1, check 16 | yes |
| **A4** `canon_substitute` | T1 | check 2 *(primary)* · check 3 · check 15 | 210 ms | check 2, check 3, check 16 | yes (+extra) |
| **A5** `canon_version_downgrade` | T1 | check 1 · check 16 | 197 ms | check 10, check 1, check 2 | yes (+extra) |
| **A6** `fork` | T1 | check 2 · check 9 · check 16 | 216 ms | check 3, check 9 | yes (+extra) |
| **A7** `checkpoint_swap` | T4 | check 5 *(primary)* · check 3 | 277 ms | check 3, check 5, check 7, check 8 | yes |
| **A8** `backdate_forward` | T4 | check 5 *(primary)* · check 3 · check 6 · check 16 | 209 ms | check 5 | yes (+extra) |
| **A9** `backdate_backward` | T4 | check 6 *(primary)* · check 5 | 201 ms | check 6 | yes (+extra) |
| **A10** `closure_mass_rewrite` | T1 | check 14 *(primary)* · check 11 | 203 ms | check 14, check 16 | yes (+extra) |
| **A11** `prev_digest_forgery` | T1 | check 11 *(primary)* | 200 ms | check 11 | yes |
| **A12** `sandbox_smuggle` | T0 | check 13 *(primary)* · check 2 · check 16 | 229 ms | check 13, check 16 | yes (+extra) |
| **A13** `trigger_disable` | T1 | check 11 *(primary)* | 329 ms | check 11, check 14 | yes |
| **A14** `receipt_orphan` | T1 | check 15 *(primary)* | 219 ms | check 15 | yes |
...
- check 14: 8 closure finding(s) [closure-severity-decreased]
...
- check 2: 1 of 74 leaves unproven [inclusion-proof-missing]
- check 13: 1 leaf/leaves carry is_sandbox = true [sandbox-leaf-present]
- check 16: 1 totality finding(s) — read no other verdict as complete [bundle-not-total]
