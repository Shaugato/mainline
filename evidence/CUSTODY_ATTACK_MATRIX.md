...
| generated_at | 2026-08-13T07:51:27Z |
...
|---|---|---|---|---|---|
| **A1** `delete_and_relink` | T1 | check 3 *(primary)* · check 2 · check 16 | 145 ms | check 3, check 2, check 16 | yes |
| **A2** `renumber_only` | T1 | check 9 *(primary)* · check 2 · check 3 · check 16 | 146 ms | check 9, check 3, check 16 | yes (+extra) |
| **A3** `payload_substitute` | T1 | check 1 *(primary)* | 164 ms | check 1, check 16 | yes |
| **A4** `canon_substitute` | T1 | check 2 *(primary)* · check 3 · check 15 | 161 ms | check 2, check 3, check 16 | yes (+extra) |
| **A5** `canon_version_downgrade` | T1 | check 1 · check 16 | 168 ms | check 10, check 1, check 2 | yes (+extra) |
| **A6** `fork` | T1 | check 2 · check 9 · check 16 | 160 ms | check 3, check 9 | yes (+extra) |
| **A7** `checkpoint_swap` | T4 | check 5 *(primary)* · check 3 | 383 ms | check 3, check 5, check 7, check 8 | yes |
| **A8** `backdate_forward` | T4 | check 5 *(primary)* · check 3 · check 6 · check 16 | 602 ms | check 5 | yes (+extra) |
| **A9** `backdate_backward` | T4 | check 6 *(primary)* · check 5 | 264 ms | check 6 | yes (+extra) |
| **A10** `closure_mass_rewrite` | T1 | check 14 *(primary)* · check 11 | 202 ms | check 14, check 16 | yes (+extra) |
| **A11** `prev_digest_forgery` | T1 | check 11 *(primary)* | 174 ms | check 11 | yes |
| **A12** `sandbox_smuggle` | T0 | check 13 *(primary)* · check 2 · check 16 | 167 ms | check 13, check 16 | yes (+extra) |
| **A13** `trigger_disable` | T1 | check 11 *(primary)* | 170 ms | check 11, check 14 | yes |
| **A14** `receipt_orphan` | T1 | check 15 *(primary)* | 170 ms | check 15 | yes |
