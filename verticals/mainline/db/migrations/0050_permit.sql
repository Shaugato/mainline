...
--
-- MAINLINE · 0050_permit.sql
-- CREATE TABLE mainline.permit — the protected branch, and the refusals that guard its merge
--
...
--
-- @projects   mainline.permit.open_blocking
-- @projects   mainline.permit.open_residue
-- @projects   mainline.permit.open_conflicts
-- @projects   mainline.permit.open_warrants
-- @projects   mainline.permit.unmodelled_asset_count
-- @projects   mainline.permit.unmet_floor_count
-- @projects   mainline.permit.countersigned_count
-- @projects   mainline.permit.site_role
-- @on_missing raise
