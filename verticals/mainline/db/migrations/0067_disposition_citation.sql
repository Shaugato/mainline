...
--
-- MAINLINE · 0067_disposition_citation.sql
-- CREATE TABLE mainline.disposition_citation — gist may accuse, only verbatim may acquit
--
-- MI: MI11
-- I: I11
-- COUNSEL-GATED: yes
...
CREATE TABLE mainline.disposition_citation (
  disposition_id UUID NOT NULL REFERENCES mainline.disposition (disposition_id),
