...
--
-- MAINLINE · 0128i_trg_refuse_mutation_clause_version.sql
-- CREATE TRIGGER append_only ON mainline.clause_version
--
-- MI: MI01
-- I: I01
-- COUNSEL-GATED: no
...
-- requires: 0107 mainline.fn_refuse_mutation · mainline.clause_version
-- sqlstate: P0001, on every UPDATE and every DELETE, for every role, forever.
-- forward-only; no .down.sql and no .up.sql (MR-5).

CREATE TRIGGER append_only BEFORE UPDATE OR DELETE ON mainline.clause_version
