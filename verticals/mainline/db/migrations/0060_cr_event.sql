...
--
-- MAINLINE · 0060_cr_event.sql
-- CREATE TABLE mainline.cr_event — a chain, not a tree
--
-- MI: MI09, MI10, MI24
-- I: I04, I01
-- COUNSEL-GATED: no
...
--                stored predecessor by mainline.fn_cr_event_chain, never trusted
...
CREATE TABLE mainline.cr_event (
  cr_id         UUID   NOT NULL,
  seq           INT8   NOT NULL,
