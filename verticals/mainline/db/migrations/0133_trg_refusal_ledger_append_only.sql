...
--
-- MAINLINE · 0133_trg_refusal_ledger_append_only.sql
-- CREATE TRIGGER trg_refusal_ledger_append_only ON mainline.refusal_ledger
--
-- MI: MI01
-- I: I01, I14
-- COUNSEL-GATED: no
...
CREATE TRIGGER trg_refusal_ledger_append_only
  BEFORE INSERT OR UPDATE OR DELETE ON mainline.refusal_ledger
  FOR EACH ROW EXECUTE FUNCTION mainline.fn_refusal_ledger_guard();
