...
-- domain:     recall
-- statements: 2 — DELIBERATE, AND THE ONLY HONEST SHAPE. One function, two vector sidecars, one
--             mechanism. A migration that welds the projection onto `event_cue_embedding` but
--             not onto `event_cue_coarse` leaves the sweep's blocking column forgeable in every
...
-- requires:   0114 mainline.fn_cue_prefix_project · 0041 event_cue_embedding
--             · 0042 event_cue_coarse
-- sqlstate:   P0001
