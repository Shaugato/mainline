...
-- requires:   0005 CREATE SCHEMA mainline_ops · 0020a mainline.site
...
-- in the schema (migration 0020a); a lease is the first thing created for a new site's ledger, so
