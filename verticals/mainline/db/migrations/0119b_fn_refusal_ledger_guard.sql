...
--
-- MAINLINE · 0119b_fn_refusal_ledger_guard.sql
-- CREATE FUNCTION mainline.fn_refusal_ledger_guard — append-only, and the allegation firewall as a structural check
--
-- MI: MI01
-- I: I01, I14, I15
-- COUNSEL-GATED: no
...
CREATE FUNCTION mainline.fn_refusal_ledger_guard() RETURNS TRIGGER
  LANGUAGE plpgsql
  AS $fn$
DECLARE
