...
--
-- MAINLINE · 0003_schema_audit.sql
-- CREATE SCHEMA mainline_audit — the MCP-facing views, each shaped to 25 rows and 10 KiB
--
-- MI: MI01
-- I: I16
-- COUNSEL-GATED: no
...
CREATE SCHEMA IF NOT EXISTS mainline_audit;
