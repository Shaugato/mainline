...
--
-- MAINLINE · 0064_defeater_option.sql
-- CREATE TABLE mainline.defeater_option — generated per check, so no global "N/A" exists
--
-- MI: MI11
-- I: I10
-- COUNSEL-GATED: no
...
CREATE TABLE mainline.defeater_option (
