...
--
-- MAINLINE · 0071b_epoch_pin_cr.sql
-- ALTER TABLE mainline.merge_record ADD CONSTRAINT epoch_pin_cr — the pin
--
-- MI: MI07
-- I: I03
-- COUNSEL-GATED: no
...
ALTER TABLE mainline.merge_record
  ...
  REFERENCES mainline.change_request (cr_id, gate_epoch)
