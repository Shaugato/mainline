...
--
-- MAINLINE · 0126_trg_cr_event_chain.sql
...
-- requires: 0106 mainline.fn_cr_event_chain
--           · mainline.cr_event
...
CREATE TRIGGER cr_event_chain BEFORE INSERT ON mainline.cr_event
  FOR EACH ROW EXECUTE FUNCTION mainline.fn_cr_event_chain();
