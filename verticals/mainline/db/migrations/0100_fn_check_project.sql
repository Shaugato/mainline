...
--
-- MAINLINE · 0100_fn_check_project.sql
-- CREATE FUNCTION mainline.fn_check_project — severity and virulence are projections, never inputs
--
-- MI: MI25, MI01
-- I: I02
-- COUNSEL-GATED: no
...
-- requires:   mainline.clause_blame_current (the binding's declared authority relation) ·
--             mainline.blocking_check (migration 0058, RENDERED, kernel
--             `obligation-and-clearance`) · mainline.virulence_class (0013)
-- provides:   mainline.fn_check_project() — welded to blocking_check by 0120
...
--   (b) the RAISE is P0001 and its message begins 'MAINLINE: ';
