...
--
-- MAINLINE · 0015_type_blame_state.sql
-- CREATE TYPE mainline.blame_state — the lifecycle of a blame edge
--
-- MI: MI15
-- I: I05
-- COUNSEL-GATED: no
...
CREATE TYPE IF NOT EXISTS mainline.blame_state AS ENUM (
  'active',
  'provisional',
  'dormant',
  'refuted'
