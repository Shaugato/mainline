...
--
-- MAINLINE · 0105_fn_permit_event_chain.sql
-- CREATE FUNCTION mainline.fn_permit_event_chain — the permit event chain is verified against its predecessor
--
-- MI: MI01, MI09, MI24
-- I: I04
-- COUNSEL-GATED: no
...
-- requires:   mainline.permit_event (migration 0059,
--             RENDERED, kernel `subject-and-pin`) with columns seq, prev_seq, prev_digest and
--             the STORED chain_digest
-- provides:   mainline.fn_permit_event_chain() — welded to permit_event by 0125
