...
--
-- MAINLINE · 0128j_trg_refuse_mutation_clause_blame_closure.sql
-- CREATE TRIGGER append_only ON mainline.clause_blame_closure
--
-- MI: MI01
-- I: I01
-- COUNSEL-GATED: no
...
-- requires: 0107 mainline.fn_refuse_mutation · mainline.clause_blame_closure
