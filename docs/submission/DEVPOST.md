...
Measured over the paste blocks only on `2026-08-14`: **15 blocks, 6,583 words**, elevator
pitch **163 characters** against a cap of 200, one sentence. Three earlier versions of this
...
> as `2026-08-12`. **`NOTRUN` means NOT CHECKED and is never a pass**, which is why the census
