...
Measured over the paste blocks only on `2026-08-15`: **15 blocks, 7,234 words**, elevator
pitch **163 characters** against a cap of 200, one sentence. It read **6,583** on
`2026-08-14`; the `651` words are the corrections in *How we built it*, *Limitations* items
