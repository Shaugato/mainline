...
--
-- TRAPPOINT_REF · 0058_blocking_check.sql
-- CREATE TABLE trappoint_ref.blocking_check — the obligation the gate counts
--
-- MI: MI25, MI02, MI30
-- I: I02
-- COUNSEL-GATED: no
...
CREATE TABLE trappoint_ref.blocking_check (
  ...
  precursor_event_id UUID NULL REFERENCES trappoint_ref.event (event_id),
  origin             STRING NOT NULL,
  -- ▼ PROJECTIONS. Overwritten by fn_check_project from trappoint_ref.clause_blame_current.
  ...
  -- ▲
  control_delta      trappoint_ref.control_delta NULL,
