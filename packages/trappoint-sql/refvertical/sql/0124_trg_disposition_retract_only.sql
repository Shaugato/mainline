...
--
-- TRAPPOINT_REF · 0124_trg_disposition_retract_only.sql
...
-- requires: 0104 trappoint_ref.fn_disposition_retract_only · 0066 trappoint_ref.disposition
...
CREATE TRIGGER disposition_retract_only BEFORE UPDATE ON trappoint_ref.disposition
  FOR EACH ROW EXECUTE FUNCTION trappoint_ref.fn_disposition_retract_only();
