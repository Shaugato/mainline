...
--
-- TRAPPOINT_REF · 0062_exposure_line.sql
-- CREATE TABLE trappoint_ref.exposure_line — one line per obligation actually rendered
--
-- MI: MI12
-- I: I09
-- COUNSEL-GATED: no
...
CREATE TABLE trappoint_ref.exposure_line (
  receipt_id     UUID NOT NULL REFERENCES trappoint_ref.exposure_receipt (receipt_id),
