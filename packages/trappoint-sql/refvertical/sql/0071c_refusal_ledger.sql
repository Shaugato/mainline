...
--
-- TRAPPOINT_REF · 0071c_refusal_ledger.sql
-- CREATE TABLE trappoint_ref.refusal_ledger — one row per refusal, constraint name verbatim
--
-- MI: MI01, MI02
-- I: I14, I01, I15
-- COUNSEL-GATED: no
...
CREATE TABLE trappoint_ref.refusal_ledger (
