...
--
-- TRAPPOINT_REF · 0010_type_control_delta.sql
-- CREATE TYPE trappoint_ref.control_delta — the control lattice
--
-- MI: MI23
-- I: I12
-- COUNSEL-GATED: no
...
CREATE TYPE IF NOT EXISTS trappoint_ref.control_delta AS ENUM (
  'introduce',
  'strengthen',
  'restate',
  'weaken',
