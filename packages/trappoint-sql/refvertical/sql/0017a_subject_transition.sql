...
--
-- TRAPPOINT_REF · 0017a_subject_transition.sql
-- CREATE TABLE trappoint_ref.subject_transition — the legal edge set as data
--
-- MI: MI10
-- I: I04
-- COUNSEL-GATED: no
...
CREATE TABLE trappoint_ref.subject_transition (
