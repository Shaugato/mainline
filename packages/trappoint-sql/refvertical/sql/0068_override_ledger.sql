...
--
-- TRAPPOINT_REF · 0068_override_ledger.sql
-- CREATE TABLE trappoint_ref.override_ledger — the escalation ladder, scoped to the person
--
-- MI: MI29
-- I: I10
-- COUNSEL-GATED: yes
...
CREATE TABLE trappoint_ref.override_ledger (
  ...
  CONSTRAINT fk_override_disposition FOREIGN KEY (disposition_id)
    REFERENCES trappoint_ref.disposition (disposition_id),
