...
--
-- TRAPPOINT_REF · 0052_permit_clause.sql
-- CREATE TABLE trappoint_ref.permit_clause — declared scope, pinned to an exact clause version
--
-- MI: MI05
-- I: I02
-- COUNSEL-GATED: no
...
CREATE TABLE trappoint_ref.permit_clause (
