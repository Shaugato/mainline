...
--
-- TRAPPOINT_REF · 0051_change_request.sql
-- CREATE TABLE trappoint_ref.change_request — the document branch is gated too (finding S16)
--
-- MI: MI30, MI03, MI04
-- I: I02, I03
-- COUNSEL-GATED: no
...
--
-- @projects   trappoint_ref.change_request.open_blocking
-- @projects   trappoint_ref.change_request.open_residue
-- @projects   trappoint_ref.change_request.open_conflicts
-- @projects   trappoint_ref.change_request.site_role
-- @on_missing raise
...
CREATE TABLE trappoint_ref.change_request (
