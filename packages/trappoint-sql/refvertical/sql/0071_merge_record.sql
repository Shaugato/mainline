...
--
-- TRAPPOINT_REF · 0071_merge_record.sql
-- CREATE TABLE trappoint_ref.merge_record — at most one completion per subject, ever
--
-- MI: MI07, MI09
-- I: I03, I04
-- COUNSEL-GATED: no
...
CREATE TABLE trappoint_ref.merge_record (
