...
--
-- TRAPPOINT_REF · 0107_fn_refuse_mutation.sql
-- CREATE FUNCTION trappoint_ref.fn_refuse_mutation — there is no legal mutation of an evidentiary row
--
-- MI: MI01
-- I: I01
-- COUNSEL-GATED: no
...
-- provides:   trappoint_ref.fn_refuse_mutation() — welded by 0128 and its companions
...
CREATE FUNCTION trappoint_ref.fn_refuse_mutation() RETURNS TRIGGER LANGUAGE PLpgSQL AS $$
BEGIN
