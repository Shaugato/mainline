...
--
-- TRAPPOINT_REF · 0018a_clearance_legal.sql
-- CREATE TABLE trappoint_ref.clearance_legal — the typed clearance lattice
--
-- MI: MI11
-- I: I10
-- COUNSEL-GATED: no
...
CREATE TABLE trappoint_ref.clearance_legal (
