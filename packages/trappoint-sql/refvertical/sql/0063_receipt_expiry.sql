...
--
-- TRAPPOINT_REF · 0063_receipt_expiry.sql
-- CREATE TABLE trappoint_ref.receipt_expiry — the sweeper MARKS by writing a new row
--
-- MI: MI12
-- I: I09
-- COUNSEL-GATED: no
...
CREATE TABLE trappoint_ref.receipt_expiry (
