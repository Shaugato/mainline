...
--
-- TRAPPOINT_REF · 0125_trg_permit_event_chain.sql
...
-- requires: 0105 trappoint_ref.fn_permit_event_chain
--           · trappoint_ref.permit_event
...
CREATE TRIGGER permit_event_chain BEFORE INSERT ON trappoint_ref.permit_event
  FOR EACH ROW EXECUTE FUNCTION trappoint_ref.fn_permit_event_chain();
