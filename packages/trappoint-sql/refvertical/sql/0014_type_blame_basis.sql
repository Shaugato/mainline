...
--
-- TRAPPOINT_REF · 0014_type_blame_basis.sql
-- CREATE TYPE trappoint_ref.blame_basis — the evidential force of a blame edge
--
-- MI: MI13
-- I: I11
-- COUNSEL-GATED: no
...
CREATE TYPE IF NOT EXISTS trappoint_ref.blame_basis AS ENUM (
  'asserted_document',
  'asserted_human',
  'derived_documentary',
  'inferred_semantic'
