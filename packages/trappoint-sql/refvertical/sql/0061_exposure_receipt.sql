...
--
-- TRAPPOINT_REF · 0061_exposure_receipt.sql
-- CREATE TABLE trappoint_ref.exposure_receipt — what was actually shown, when, over what corpus
--
-- MI: MI12
-- I: I09
-- COUNSEL-GATED: no
...
CREATE TABLE trappoint_ref.exposure_receipt (
