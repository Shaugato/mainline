...
--
-- TRAPPOINT_REF · 0128_trg_refuse_mutation.sql
-- CREATE TRIGGER append_only ON trappoint_ref.permit_event
--
-- MI: MI01
-- I: I01
-- COUNSEL-GATED: no
...
-- requires: 0107 trappoint_ref.fn_refuse_mutation · trappoint_ref.permit_event
...
--   0128  trappoint_ref.permit_event
--   0128a  trappoint_ref.cr_event
--   0128b  trappoint_ref.blocking_check
--   0128c  trappoint_ref.merge_record
--   0128d  trappoint_ref.exposure_receipt
--   0128e  trappoint_ref.exposure_line
--   0128f  trappoint_ref.override_ledger
--   0128g  trappoint_ref.person
--   0128h  trappoint_ref.signing_credential
--   0128i  trappoint_ref.clause_version
--   0128j  trappoint_ref.clause_blame_closure

CREATE TRIGGER append_only BEFORE UPDATE OR DELETE ON trappoint_ref.permit_event
