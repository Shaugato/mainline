...
--
-- TRAPPOINT_REF · 0017b_subject_transition_seed.sql
-- SEED trappoint_ref.subject_transition — 9 edges for each of 2 kinds
--
-- MI: MI10
-- I: I04
-- COUNSEL-GATED: no
...
INSERT INTO trappoint_ref.subject_transition (subject_kind, from_state, to_state) VALUES
