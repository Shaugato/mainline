...
--
-- TRAPPOINT_REF · 0053_cr_clause.sql
-- CREATE TABLE trappoint_ref.cr_clause — declared scope, pinned to an exact clause version
--
-- MI: MI30
-- I: I02
-- COUNSEL-GATED: no
...
CREATE TABLE trappoint_ref.cr_clause (
  cr_id        UUID   NOT NULL,
