...
--
-- TRAPPOINT_REF · 0059_permit_event.sql
-- CREATE TABLE trappoint_ref.permit_event — a chain, not a tree
--
-- MI: MI09, MI10, MI24
-- I: I04, I01
-- COUNSEL-GATED: no
...
--                stored predecessor by trappoint_ref.fn_permit_event_chain, never trusted
...
CREATE TABLE trappoint_ref.permit_event (
