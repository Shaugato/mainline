...
for the same reason: the workspace ``pyproject.toml``/``uv.lock`` are owned by the
kernel toolchain worker, and until they land these tests must still be runnable
